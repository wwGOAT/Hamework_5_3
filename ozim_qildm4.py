...
# boshlang'ich va oxirgi sonlarni olib, ular orasidagi juft sonlarni
# ekranga chiqaradi.
...
# Berilgan sonlarning juftini generatsiya qilish
def filter_odd_numbers(numbers):
    for num in numbers:
        if num % 2 == 0:
            yield num

# Berilgan sonlarning juftini ko'rsatish
...
def main():
    ...
    print(f"{start} dan {end} gacha bo'lgan juft sonlar:")
